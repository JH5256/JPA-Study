...
public class SimpleJPQLRepository {
    ...
    public List<Menu> selectUsingIn() {
        ...
        TypedQuery<Menu> query = entityManager.createQuery(jpql, Menu.class);
        List<Menu> resultMenuByCategory = query.getResultList();

        return resultMenuByCategory;
    }
...
//        TypedQuery<Menu> query = entityManager.createQuery(jpql, Menu.class);
//        List<Menu> resultMenuNameBySelect = query.getResultList();

        List<Menu> resultMenuNameBySelect = entityManager.createQuery(jpql, Menu.class).getResultList();

        return resultMenuNameBySelect;
    }
